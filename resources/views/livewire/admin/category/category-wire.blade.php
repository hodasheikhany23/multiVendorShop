    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">{{__('validation.attributes.list_category')}} </h3>
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <div class="dropdown dropdown-inline">
                                <a wire:navigate href="{{ route('admin.category.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head-- align-items-center">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{__('validation.attributes.list_category')}}
                    </h3>
                </div>
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    @foreach($categories as $c)
                        <tr>
                            ...
                            <td>
                                @if(app()->getLocale()==='fa')
                                    {{$c->parent ? $c->parents_path : 'بدون والد'}}
                                @else
                                    @if($c->parent != null)
                            ...
                            <td class="text-center d-flex justify-content-between">
                                <a wire:click="deleteCategory({{$c->id}})" class="text-danger btn btn-bolder border-danger btn-sm d-flex justify-content-center align-items-center" style="width:35px; height:35px;">
                                    <i class="fa fa-trash"></i>
                                </a>
                                <a wire:navigate href="{{ route('admin.category.edit', ['category' => $c->id ])}}"  class="text-info btn btn-bolder border-info btn-sm d-flex justify-content-center align-items-center" style="width:35px; height:35px; margin-left:5px;">
                ...
                <div class="mt-2">
                    @if(app()->getLocale() === 'fa')
                        نمایش {{ $categories->firstItem() }} تا {{ $categories->lastItem() }} از {{ $categories->total() }} نتیجه
                    @endif
                </div>
                {{$categories->links()}}
                <!--end: Datatable -->
