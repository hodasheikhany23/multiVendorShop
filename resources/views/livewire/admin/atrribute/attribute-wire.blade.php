    ...
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">{{__('validation.attributes.list_attribute')}} </h3>
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <div class="dropdown dropdown-inline">
                                <a wire:navigate href="{{ route('admin.attribute.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head-- align-items-center">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{__('validation.attributes.list_attribute')}}
                    </h3>
                </div>
            ...
            <div class="kt-portlet__body">
                    ...
                    @foreach($attribute as $a)
                        <tr>
                            ...
                            <td class="text-center d-flex justify-content-between">
                                <a wire:click="deleteAttribute({{$a->id}})" class="text-danger btn btn-bolder border-danger btn-sm d-flex justify-content-center align-items-center" style="width:35px; height:35px;">
                                    <i class="fa fa-trash"></i>
                                </a>
                                <a wire:navigate href="{{ route('admin.attribute.edit', ['attribute' => $a->id ])}}"  class="text-info btn btn-bolder border-info btn-sm d-flex justify-content-center align-items-center" style="width:35px; height:35px; margin-left:5px;">
                ...
                {{--                <div class="mt-2">--}}
                {{--                    @if(app()->getLocale() === 'fa')--}}
                {{--                        نمایش {{ $attributes->firstItem() }} تا {{ $attributes->lastItem() }} از {{ $attributes->total() }} نتیجه--}}
                {{--                    @endif--}}
                {{--                </div>--}}
                {{--                {{$attributefs->links()}}--}}
                {{--                <!--end: Datatable -->--}}
