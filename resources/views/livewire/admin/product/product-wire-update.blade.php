                            ...
                            <div class="kt-wizard-v3__nav-items">
                                ...
                                <a class="kt-wizard-v3__nav-item" href="#" data-ktwizard-type="step"
                                   @if($currentStep==2)data-ktwizard-state="current"@endif>
                                    <div class="kt-wizard-v3__nav-body">
                                        <div class="kt-wizard-v3__nav-label">
                                            <span>2</span> {{__('validation.attributes.details')}}
                                        </div>
                                        <div class="kt-wizard-v3__nav-bar"></div>
                                    </div>
                                </a>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select wire:model.live="vendor_id" name="user"
                                                ...
                                                @foreach($vendors as $v)
                                                    <option value="{{$v->id}}" @if($vendor_id == $v->id) selected @endif}}>{{$v->id}} ___ {{$v->name}}
                                                        __{{$v->phone}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="kt-wizard-v3__content" data-ktwizard-type="step-content"
                                ...
                                <div class="kt-form__section kt-form__section--first">
                                    <div class="kt-wizard-v3__form">
                                        ...
                                        <label>{{__('validation.attributes.image')}} <label>{{__('validation.attributes.product')}}</label></label>
                                        <div class="row">
                                            <div id="product-dropzone" class="dropzone d-flex justify-content-center align-items-center flex-column border-primary">
                                                <i class="fa fa-images" style="font-size: 24px; color:var(--color-main)"></i>
