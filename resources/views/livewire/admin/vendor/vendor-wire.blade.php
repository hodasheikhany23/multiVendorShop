                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <div class="dropdown dropdown-inline">
                                <a wire:navigate href="{{ route('admin.vendor.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    <tr>
                        ...
                        <th>{{__('validation.attributes.f_name')}}</th>
                        <th>{{__('validation.attributes.l_name')}}</th>
                        <th>{{__('validation.attributes.province')}}</th>
                    ...
                    @foreach($vendors as $v)
                        <tr>
                            ...
                            <td class="text-center d-flex justify-content-between">
                                ...
                                <a wire:navigate href="{{route('admin.vendor.edit',['vendor'=>$v->id])}}" class="text-info btn btn-bolder border-info btn-sm d-flex justify-content-center align-items-center" style="width:35px; height:35px; margin-left:5px;">
                ...
                <div class="mt-2">
                    @if(app()->getLocale() === 'fa')
                        نمایش {{ $vendors->firstItem() }} تا {{ $vendors->lastItem() }} از {{ $vendors->total() }} نتیجه
                    @endif
                </div>
                {{$vendors->links()}}
                <!--end: Datatable -->
