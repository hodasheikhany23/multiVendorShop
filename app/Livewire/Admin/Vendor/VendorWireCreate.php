...
class VendorWireCreate extends Component
{
    use WithFileUploads;
    ...
    public $user_id=null;
    public $f_name = null;
    public $f_name_en = null;
    public $l_name = null;
    public $l_name_en = null;
    public $phone = null;
...
//    public $username, $password, $password_confirmation;
        ...
        try {
            ...
            if ($this->logo) {
                try{
                    ...
                    $this->msg =__('validation.massages.add_failed',['item'=> __('validation.attributes.logo')]);
                    $this->msg_status ='failed';
                    ActivityLog::log('vendor',null,'create','failed to create vendor (logo image error) __'.$e->getMessage());
                }

            }
            ActivityLog::log('vendor',$vendor->id,'create','vendor created successfully');

            $this->msg =__('validation.massages.add_success',['item'=> __('validation.attributes.vendor')]);
            ...
            $this->msg =__('validation.massages.add_failed',['item'=> __('validation.attributes.vendor')]);
            $this->msg_status ='failed';
            ActivityLog::log('vendor',null,'create','failed to create vendor __'.$e->getMessage());
        }
    }
    public function render()
    {
        ...
        $this->users = User::all();
        return view('livewire.admin.vendor.vendor-wire-create', ['currentStep' => $this->currentStep])
            ->layout('layouts.app');
    }
}
